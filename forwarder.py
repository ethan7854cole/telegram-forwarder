...
GROUP_NAMES = {
    -1004330276394: "MH X LARRY CHIME 1 to CHIME GAFFER",
    -5353420212: "MH X LARRY CHIME 2 to CHIME PICCASO",
    -5339749243: "MH X LARRY VENMO to GAFFER VENMO and PICCASO VENMO",
}
forwarded_count = 0
today_count = 0
